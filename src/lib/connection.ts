 ...
 * галочке: браузерное хранилище не шифруется, и держать там пароль от продуктивной
...
/** Среда стенда. Порядок — жизненный цикл: разработка → продуктив. */
 ...
 *
 * У шины и её брокера один хозяин и один стенд: разработка, тест, продуктив.
